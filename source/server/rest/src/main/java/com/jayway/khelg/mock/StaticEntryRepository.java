...
public class StaticEntryRepository implements EntryRepository {
    ...
    public StaticEntryRepository() {
        entries.add(new EntryImpl(1, "Welcome to Cars", "Some text about cars."));
        entries.add(new EntryImpl(1, "Welcome to Guns", "Some text about guns."));
        entries.add(new EntryImpl(1, "Welcome to Houses", "Some text about houses."));
        entries.add(new EntryImpl(1, "Welcome to Cats", "Some text about cats."));
    }
